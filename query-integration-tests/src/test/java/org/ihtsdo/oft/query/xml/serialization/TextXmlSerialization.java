...
public class TextXmlSerialization {
    ...
    public void andTest() throws IOException, JAXBException {
        ...
        System.out.println("Query 1 vc: " + ((ViewCoordinate)query.getLetDeclarations().get("Current view coordinate")).getLangPrefConceptSpecList());
        System.out.println("Query 2 vc: " + ((ViewCoordinate)query2.getLetDeclarations().get("Current view coordinate")).getLangPrefConceptSpecList());
