...
public class ConceptProvider implements ConceptService {
    ...
    public ConceptProvider() throws Exception {
        ...
        delegateService = (DelegateService) delegate;
    ...
    private void startMe() throws IOException {
        ...
        delegateService.startDelegateService();
    }
    @PreDestroy
    private void stopMe() throws IOException {
        log.info("Stopping ConceptProvider.");
        delegateService.stopDelegateService();
    }    
}
